...
public class DBConfig {
    ...
    final public static String createLeciona = "CREATE TABLE Leciona (\n" +
            ...
            "\t\tREFERENCES Materia (cod_materia)\n" +
            ");";
    final public static String triggerAttTurma = "DELIMITER $$\n" +
            ...
            "END;\n" +
            "$$";
    final public static String triggerAttTurmaLog = "DELIMITER $$\n" +
            ...
            "END;\n" +
            "$$";
    final public static String triggerDelTurmaLog = "DELIMITER $$\n" +
            ...
            "END;\n" +
            "$$";
    final public static String triggerInsertTurmaLog = "DELIMITER $$\n" +
            ...
            "END;\n" +
            "$$";
    final public static String functionMensalidadeJuros = "DELIMITER $$\n" +
            ...
            "end\n" +
            "$$\n";
    final public static String functionSalario = "DELIMITER $$\n" +
            ...
            "end$$\n" +
            "DELIMITER ;\n";
    final public static String functionMateriasAluno = "DELIMITER $\n" +
            ...
            "end\n" +
            "$ \n";
    final public static String procedureInsereMinistrar = "DELIMITER $$\n" +
            ...
            "END IF;\n" +
            "END $$";
    final public static String procedureInsereInscrito = "DELIMITER $$\n" +
            ...
            "END IF;\n" +
            "END $$";
    final public static String procedureInsereTurma = "DELIMITER $$\n" +
            ...
            "END;\n" +
            "$$";
    final public static String insertFilial = "INSERT INTO Filial (cod_filial,nome,endereco) VALUES(1024170215,\"Thaten55\",\"Rua Ipê 1215\");\n" +
    ...
    final public static String insertSala = "INSERT INTO Sala (cod_filial,num_sala,numMaxAlunos) VALUES(1003327259,102,35);\n" +
    ...
    final public static String insertAluno = "INSERT INTO Aluno (matricula_aluno,nome,desconto,endereco,turno,mensalidadeBasica) VALUES(1000031637,\"Bianca B Sousa\",48.23,\"Rua Sebastião Barbosa 483\",\"Manhã\",1034.08);\n" +
    ...
    final public static String insertVinculado = "INSERT INTO Vinculado (cod_filial,matricula_aluno) VALUES(1043640476,1000031637);\n" +
    ...
    final public static String insertMateria = "INSERT INTO Materia (cod_materia,horasPorSemana,mensalidade,nome) VALUES(1006604244,6,105.34,\"Matemática I\");\n" +
    ...
    final public static String insertHorario = "INSERT INTO Horario (dia,inicio) VALUES (1,8);\n" +
    ...
    final public static String insertProfessor = "INSERT INTO Professor (matricula_professor,nome,endereco,horaAula) VALUES(1001955977,\"Nicolas S Pereira\",\"Rua Monte Castelo 424\",875.69);\n" +
    ...
    final public static String insertDisponivel = "INSERT INTO Disponivel (matricula_professor,dia,inicio) VALUES (1001955977,2,13);\n" +
    ...
    final public static String insertLeciona = "INSERT INTO Leciona (matricula_professor,cod_materia) VALUES(1001955977,1066069257);\n" +
    ...
    final public static String insertTurma = "INSERT INTO Turma (cod_turma,num_sala,cod_filial,cod_materia,numMaxAlunos,ano) VALUES (1057364200,102,1003327259,1006604244,30,2015);\n" +
    ...
    final public static String insertInscrito = "INSERT INTO Inscrito (cod_turma,matricula_aluno) VALUES(1057364200,1000031637);\n" +
    ...
    final public static String insertMinistrar = "INSERT INTO Ministrar (cod_turma,matricula_professor) VALUES(1069156297,1001955977);\n" +
    ...
    final public static String insertMarcado = "INSERT INTO Marcado (cod_turma,dia,inicio) VALUES (1069156297,2,13);\n" +
